    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: "var(--taxi-dark)" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", lineHeight: 1.7 }}>
        <h2 style={{ fontFamily: "Montserrat", fontWeight: 800, fontSize: 18, color: "#F0F2F5", marginBottom: 12 }}>
          Условия использования сервиса Антипиха Taxi
        </h2>
        <p style={{ fontSize: 13, color: "var(--taxi-muted)", marginBottom: 16 }}>Дата вступления в силу: 1 марта 2026 г.</p>

        <Section title="1. Общие положения">
          Настоящее Соглашение регулирует отношения между пользователем и сервисом Антипиха Taxi. Используя приложение, вы подтверждаете согласие с условиями данного документа. Сервис предоставляет платформу для связи пассажиров и водителей такси.
        </Section>
        ...
        <Section title="8. Ответственность">
          Сервис Антипиха Taxi является информационной платформой и не несёт ответственности за действия водителей и пассажиров. Все споры решаются через службу поддержки. Мы стремимся обеспечить максимально безопасный и качественный сервис.
        </Section>
